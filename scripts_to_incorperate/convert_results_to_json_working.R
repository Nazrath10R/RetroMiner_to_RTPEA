...
#### reset counter #### 
counter_data <- fromJSON("/Users/nazrathnawaz/Dropbox/PhD/retroelement_expression_atlas/data/Homepage/CounterData.json")
counter_data$prideDatasets <- 0
counter_data$samples <- 0
counter_data$specSize <- 0
write.json(counter_data, "/Users/nazrathnawaz/Dropbox/PhD/retroelement_expression_atlas/data/Homepage/CounterData.json")
...
table <- read.table("./output_table4_with_consequence.txt", sep= "\t", header = TRUE)
